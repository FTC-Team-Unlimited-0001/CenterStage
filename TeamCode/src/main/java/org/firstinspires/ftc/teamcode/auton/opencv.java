...
public class opencv extends LinearOpMode {
    public centerStageMachine robot;

    public static double cX = 0;
    public static double cY = 0;
    public static double width = 0;
    public static int sleep1 = 1900;
    public static int sleep2 = 1000;
    public static int sleep3 = 1050 ;
    public static int sleep4 = 1300;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if ((int) opencv.cX<350 & (int) opencv.cX > 200){
    ...
    class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
            ...
            Scalar lowerYellow = new Scalar(r1, g1, b1);
            Scalar upperYellow = new Scalar(r2, g2, b2);
